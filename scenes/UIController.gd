...
var account_select: OptionButton
var select_account_button: Button
...
var create_harvester_button: Button
var create_fighter_button: Button
var map_button: Button
var primary_action_bar: Control
var inventory_panel: Control
var skills_panel: Control
var map_panel: Control
var town_panel: Control
var zone_panel: Control
var node_panel: Control

var _log_lines: Array = []

func init(root_control: Control):
	root = root_control
	_cache_nodes()
	set_process(true)
	_connect_buttons()
...
func _cache_nodes():
	log_box = root.get_node("ScrollContainer/MarginContainer/VBoxContainer/LogBox")
	status_label = root.get_node("ScrollContainer/MarginContainer/VBoxContainer/Status")
	account_box = root.get_node("ScrollContainer/MarginContainer/VBoxContainer/AccountBox")
	account_select = root.get_node("ScrollContainer/MarginContainer/VBoxContainer/AccountBox/AccountSelectRow/AccountSelect")
	select_account_button = root.get_node("ScrollContainer/MarginContainer/VBoxContainer/AccountBox/AccountSelectRow/SelectAccountButton")
	account_name_input = root.get_node("ScrollContainer/MarginContainer/VBoxContainer/AccountBox/AccountCreateRow/AccountNameInput")
	create_account_button = root.get_node("ScrollContainer/MarginContainer/VBoxContainer/AccountBox/AccountCreateRow/CreateAccountButton")
	character_box = root.get_node("ScrollContainer/MarginContainer/VBoxContainer/CharacterBox")
	name_input = root.get_node("ScrollContainer/MarginContainer/VBoxContainer/CharacterBox/CharacterNameRow/NameInput")
	character_select = root.get_node("ScrollContainer/MarginContainer/VBoxContainer/CharacterBox/ManageRow/CharacterSelect")
	select_button = root.get_node("ScrollContainer/MarginContainer/VBoxContainer/CharacterBox/ManageRow/SelectButton")
	delete_button = root.get_node("ScrollContainer/MarginContainer/VBoxContainer/CharacterBox/ManageRow/DeleteButton")
	create_harvester_button = root.get_node("ScrollContainer/MarginContainer/VBoxContainer/CharacterBox/CreateRow/CreateHarvesterButton")
	create_fighter_button = root.get_node("ScrollContainer/MarginContainer/VBoxContainer/CharacterBox/CreateRow/CreateFighterButton")
	map_button = root.get_node("ScrollContainer/MarginContainer/VBoxContainer/NavigationRow/MapButton")
	primary_action_bar = root.get_node("ScrollContainer/MarginContainer/VBoxContainer/NavigationRow/PrimaryActionBar")
	inventory_panel = root.get_node("InventoryPanel")
	skills_panel = root.get_node("SkillsPanel")
	map_panel = root.get_node("MapPanel")
	town_panel = root.get_node("TownPanel")
	zone_panel = root.get_node("ZonePanel")
	node_panel = root.get_node("NodePanel")
